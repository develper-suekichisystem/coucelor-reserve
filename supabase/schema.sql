...
INSERT INTO menus (name, price, duration_minutes, description, sort_order) VALUES
  ('初回カウンセリング', 5000, 60, 'あなたのお悩みをゆっくりお聞かせください。初回限定特別料金です', 1),
  ('通常カウンセリング（60分）', 8000, 60, 'じっくりと向き合い、心身の不調に対応します', 2),
  ('深掘りカウンセリング（90分）', 12000, 90, 'より深く、より丁寧にあなたの問題に向き合います', 3),
  ('短時間相談（30分）', 4000, 30, 'ちょっとお話ししたい方向けの短時間プランです', 4),
  ('カウンセリング＋心理診断', 10000, 75, 'カウンセリングと心理診断を組み合わせたプレミアムコース', 5);
